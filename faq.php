...
<div class="container-fluid padding-mobile-view" style="padding-top: 20px;min-height: 700px;width: 1170px;">
      ...
      <div class="row">
      	<div class="col-sm-12">
        	<h1>FAQ</h1>
        <h3>What does StakeProtocal Dex do?</h3>
        <p>
        	StakeProtocal Dex is a decentralized exchange that allows you to trade your cryptocurrency assets securely, right from your own wallet. StakeProtocal Dex empowers you to maintain complete control of your assets throughout the entirety of the trading process, as you are never required to deposit or withdraw crypto from StakeProtocal Dex to trade.
        </p>
        <h3>What is a centalized exchange?</h3>
        <p>
        ...
        <h3>What is a DEX (Decentalized Exchange)?</h3>
        <p>
