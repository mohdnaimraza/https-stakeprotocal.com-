...
<div class="container-fluid padding-mobile-view" style="padding-top: 20px;min-height: 700px;width: 1170px;">
      ...
      <div class="row">
      	<div class="col-sm-12">
        	<h3>About Us</h3>
        <p>
        	StakeProtocal project aims to create and provide to the world, the full power of decentralized exchanges and capitalize on the interconnectivity and interoperability of cross-chain features.
        </p>
        <p>
        	We will write the right path for all traders, blockchain enthusiasts and future generations. We dream about full transparency, high security and peer to peer exchanges without the risk of having to trust third parties and additional taxes. We aim to put back into the people’s hands, the much needed financial independence.
        </p>
        <p>
        	If you share our beliefs and you have similar dreams, you can support our project, join our groups and take part in StakeProtocal and the coming blockchain revolution. Together we will bring about the much needed change for a brighter future for our own and the next generations of traders and crypto enthusiasts.
        </p>
      	</div>
      </div>
    </div>
